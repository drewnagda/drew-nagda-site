...
> = {
  ...
  "compound-effect-of-discipline": {
    ...
    youtubeId: null,
    content: [
      "everyone talks about compound interest in finance. but the real compound effect happens in your daily habits. most people never see the payoff because they quit too early.",
      ...
      "the compound effect isn't exciting. it's boring. it's repetitive. and that's exactly why it works. most people can't tolerate boring long enough to see the results.",
  ...
  "building-in-public": {
    ...
    content: [
      ...
      "the key is authenticity. not the instagram version of authenticity where everything is curated and filtered. real authenticity: the 4am mornings, the deals that fell through, the workouts you didn't want to do but did anyway.",
